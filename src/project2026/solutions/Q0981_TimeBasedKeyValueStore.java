 ...
 */
public class Q0981_TimeBasedKeyValueStore /* TimeMap */ {
    private HashMap<String, ArrayList<Node>> map;

    public Q0981_TimeBasedKeyValueStore() /* TimeMap */ {
        map = new HashMap<>();
    }
    ...
    public HashMap<String, String> freeze(int timestamp) {
        HashMap<String, String> res = new HashMap<>();
        for (String key : map.keySet()) {
            res.put(key, get(key, timestamp));
        }
        return res;
    }
